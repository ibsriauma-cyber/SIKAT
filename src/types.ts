export type Role = 'guru' | 'walas' | 'ortu' | 'bk' | 'pustaka' | 'kamad' | 'admin' | 'siswa' | 'wakakurikulum' | 'wakakesiswaan' | 'guru_quran' | 'wakatu' | 'guru_mapel' | 'kesiswaan' | 'waka' | 'tata_usaha';
